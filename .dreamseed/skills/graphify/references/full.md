...
## For the commit hook and native DREAMSEED.md integration

When the user asks to install the post-commit auto-rebuild hook or wire graphify into a project's DREAMSEED.md, see `references/hooks.md`.
