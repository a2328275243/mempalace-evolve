...
foreach ($Pattern in @("package/", "*.tgz", ".dreamseed-memory/", "legacy-history/", "memory-candidates/", "self-evolve-candidates/", "self-evolve-backups/", "logs/", "logs/hook-trace/", "dist/", "providers.local.json", "__pycache__/", "*.pyc")) {
...
foreach ($RequiredExclusion in @("__pycache__", "*.pyc", "self-evolve-candidates", "self-evolve-backups", "logs", "cache", "providers.local.json", "legacy-history", "memory-candidates")) {
...
foreach ($SecretRel in @("config\providers.local.json", ".dreamseed\providers.local.json")) {
