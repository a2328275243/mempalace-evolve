...
export type ToolUseContext = {
  ...
  /**
   * DREAMSEED.md paths already injected as nested_memory attachments this
   ...
   * re-inject the same DREAMSEED.md dozens of times.
   */
...
> = {
   ...
   * When exceeded, the result is saved to a file and DreamSeed receives a preview
