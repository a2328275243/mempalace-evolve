/**
 * Main entrypoint for DreamSeed Code Agent SDK types.
 *
...
/**
 * A scheduled task from `<dir>/.dreamseed/scheduled_tasks.json`.
 * @internal
 */
...
/**
 * Watch `<dir>/.dreamseed/scheduled_tasks.json` and yield events as tasks fire.
 *
