export const BASE_CHROME_PROMPT = `# DreamSeed Browser browser automation
...
/**
 * Minimal hint about DreamSeed Browser skill availability. This is injected at startup when the extension is installed
