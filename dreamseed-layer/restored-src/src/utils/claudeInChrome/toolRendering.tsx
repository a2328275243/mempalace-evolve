...
/**
 * Renders a clickable "View Tab" link for DreamSeed Browser MCP tools.
 * Returns null if:
 * - The tool is not a DreamSeed Browser MCP tool
...
/**
 * Returns tool method overrides for DreamSeed Browser MCP tools. Use this to customize
...
export function getClaudeInChromeMCPToolOverrides(toolName: string): {
  ...
  return {
    userFacingName(_input?: Record<string, unknown>) {
      ...
      return `DreamSeed Browser[${displayName}]`;
    },
