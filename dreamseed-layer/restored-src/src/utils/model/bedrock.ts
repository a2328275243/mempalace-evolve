...
/**
 * Check if a model ID is a foundation model (e.g., "anthropic.dreamseed-sonnet-4-5-20250929-v1:0")
 */
 ...
 * For example:
 * - "eu.anthropic.dreamseed-sonnet-4-5-20250929-v1:0" → "eu"
 * - "us.anthropic.dreamseed-3-7-sonnet-20250219-v1:0" → "us"
 * - "arn:aws:bedrock:ap-northeast-2:123:inference-profile/global.anthropic.dreamseed-opus-4-6-v1" → "global"
 * - "anthropic.dreamseed-3-5-sonnet-20241022-v2:0" → undefined (foundation model)
 ...
 *
 * For example:
 * - applyBedrockRegionPrefix("us.anthropic.dreamseed-sonnet-4-5-v1:0", "eu") → "eu.anthropic.dreamseed-sonnet-4-5-v1:0"
 * - applyBedrockRegionPrefix("anthropic.dreamseed-sonnet-4-5-v1:0", "eu") → "eu.anthropic.dreamseed-sonnet-4-5-v1:0"
