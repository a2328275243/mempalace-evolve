 ...
 * .dreamseed/settings.json) are still blocked even if their parent is in allowOnly.
 */
...
export function isPathAllowed(
  ...
  // Checks: Windows patterns, DreamSeed config files, dangerous files (on original + symlink paths)
  if (operationType !== 'read') {
