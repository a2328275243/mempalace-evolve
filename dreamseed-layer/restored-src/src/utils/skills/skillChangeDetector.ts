...
async function getWatchablePaths(): Promise<string[]> {
  ...
  // User skills directory (~/.dreamseed/skills)
  ...
  // User commands directory (~/.dreamseed/commands)
  ...
  // Project skills directory (.dreamseed/skills)
  ...
  // Project commands directory (.dreamseed/commands)
  ...
  for (const dir of getAdditionalDirectoriesForClaudeMd()) {
    const additionalSkillsPath = platformPath.join(dir, '.dreamseed', 'skills')
    try {
