...
/**
 * Convert a PersistedStatsCache to DreamSeedCodeStats by computing derived fields.
 */
...
/**
 * Aggregates stats from all DreamSeed Code sessions across all projects.
...
/**
 * Convert ProcessedStats to DreamSeedCodeStats.
