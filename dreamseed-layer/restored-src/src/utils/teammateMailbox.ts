 ...
 *
 * Each teammate has an inbox file at .dreamseed/teams/{team_name}/inboxes/{agent_name}.json
...
// Lock options: retry with backoff so concurrent callers (multiple DreamSeeds
 ...
 * Structure: ~/.dreamseed/teams/{team_name}/inboxes/{agent_name}.json
 */
