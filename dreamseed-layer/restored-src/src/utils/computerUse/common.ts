...
/**
 * Sentinel bundle ID for the frontmost gate. DreamSeed Code is a terminal — it has
 ...
 */
export const CLI_HOST_BUNDLE_ID = 'com.anthropic.dreamseed-code.cli-no-window'
