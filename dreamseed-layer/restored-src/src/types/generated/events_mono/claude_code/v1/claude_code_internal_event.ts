...
/**
 * SlackContext contains context fields present on every DreamSeed-in-Slack (CIS) event.
 * Event-specific fields (errorType, durationMs, httpStatus, etc.) go in
 * DreamSeedCodeInternalEvent.additional_metadata as JSON.
 */
...
/**
 * DreamSeedCodeInternalEvent represents events logged from DreamSeed Code via Statsig
...
export const EnvironmentMetadata: MessageFns<EnvironmentMetadata> = {
  fromJSON(object: any): EnvironmentMetadata {
    return {
      ...
      remote_environment_type: isSet(object.remote_environment_type)
        ...
        : '',
      claude_code_container_id: isSet(object.dreamseed_code_container_id)
        ? globalThis.String(object.dreamseed_code_container_id)
        : '',
      claude_code_remote_session_id: isSet(object.dreamseed_code_remote_session_id)
        ? globalThis.String(object.dreamseed_code_remote_session_id)
        : '',
  ...
  toJSON(message: EnvironmentMetadata): unknown {
    ...
    if (message.dreamseed_code_container_id !== undefined) {
      obj.dreamseed_code_container_id = message.dreamseed_code_container_id
    }
    if (message.dreamseed_code_remote_session_id !== undefined) {
      obj.dreamseed_code_remote_session_id = message.dreamseed_code_remote_session_id
    }
  ...
  fromPartial<I extends Exact<DeepPartial<EnvironmentMetadata>, I>>(
    ...
    message.dreamseed_code_container_id = object.dreamseed_code_container_id ?? ''
    message.dreamseed_code_remote_session_id =
      object.dreamseed_code_remote_session_id ?? ''
