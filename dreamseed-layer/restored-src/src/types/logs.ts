 ...
 * `dreamseed ps` can show something more useful than the last user prompt
...
/**
 * Per-file attribution state tracking DreamSeed's character contributions.
 */
 ...
 * Tracks character-level contributions by DreamSeed for commit attribution.
 */
