...
- Do not include information that's already in the DREAMSEED.md files included in the context
 ...
 * Custom prompts can be placed at ~/.dreamseed/session-memory/prompt.md
