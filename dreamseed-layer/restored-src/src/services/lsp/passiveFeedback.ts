...
/**
 * Map LSP severity to DreamSeed diagnostic severity
 *
 * Maps LSP severity numbers to DreamSeed diagnostic severity strings.
...
/**
 * Convert LSP diagnostics to DreamSeed diagnostic format
 *
 * Converts LSP PublishDiagnosticsParams to DiagnosticFile[] format
 * used by DreamSeed's attachment system.
 */
 ...
 * from all LSP servers and routes them to DreamSeed's diagnostic system.
      ...
      serverInstance.onNotification(
        ...
        (params: unknown) => {
          ...
          try {
            ...
            // Convert LSP diagnostics to DreamSeed format (can throw on invalid URIs)
