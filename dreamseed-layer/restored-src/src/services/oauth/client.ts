// OAuth client for handling authentication flows with DreamSeed services
...
export function buildAuthUrl({
  ...
  authUrl.searchParams.append('code', 'true') // this tells the login page to show DreamSeed Max upsell
