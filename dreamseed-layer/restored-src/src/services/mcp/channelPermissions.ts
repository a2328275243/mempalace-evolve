 ...
 *
 * Kenneth's "would this let DreamSeed self-approve?": the approving party is
 * the human via the channel, not DreamSeed. But the trust boundary isn't the
 ...
 * module-level (per src/DREAMSEED.md), NOT in AppState (functions-in-state
