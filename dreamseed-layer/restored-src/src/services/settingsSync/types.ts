...
export const SYNC_KEYS = {
  USER_SETTINGS: '~/.dreamseed/settings.json',
  USER_MEMORY: '~/.dreamseed/DREAMSEED.md',
  projectSettings: (projectId: string) =>
    `projects/${projectId}/.dreamseed/settings.local.json`,
  projectMemory: (projectId: string) => `projects/${projectId}/DREAMSEED.local.md`,
} as const
