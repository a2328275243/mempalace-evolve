 ...
 * persists. On next startup, `dreamseed remote-control` detects it and offers
 ...
 * and handles errors — no existence check (DREAMSEED.md TOCTOU rule). Returns
 ...
 * mutate to a worktree path — but `dreamseed remote-control --continue` runs
