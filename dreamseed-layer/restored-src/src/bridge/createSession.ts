 ...
 *
 * Used by both `dreamseed remote-control` (empty session so the user has somewhere to
 ...
 * explicit client action. Both `dreamseed remote-control` (standalone bridge) and the
