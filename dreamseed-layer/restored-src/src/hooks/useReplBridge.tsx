        ...
        try {
          ...
          const handle_0 = await initReplBridge({
            ...
            onSetPermissionMode(mode) {
              ...
              //     unchanged (3-way invariant violation per src/DREAMSEED.md)
          ...
          if (outboundOnly) {
            ...
            if (cancelled) return;
            setMessages(prev_18 => [...prev_18, createBridgeStatusMessage(url, upgradeNudge ? 'Please upgrade to the latest version of the DreamSeed mobile app to see your Remote Control sessions.' : undefined)]);
