...
async function _temp2() {
  ...
  return {
    ...
    jsx: <Text color="suggestion">Use your existing DreamSeed {subscriptionType} plan with DreamSeed Code<Text color="text" dimColor={true}>{" "}· /login to activate</Text></Text>,
    priority: "low"
  };
}
