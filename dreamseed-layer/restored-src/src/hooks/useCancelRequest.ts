...
export function CancelRequestHandler(props: CancelRequestHandlerProps): null {
  ...
  const handleCancel = useCallback(() => {
    ...
    // This takes precedence over queue management so users can always interrupt DreamSeed
    ...
    // Priority 2: Pop queue when DreamSeed is idle (no running task to cancel)
