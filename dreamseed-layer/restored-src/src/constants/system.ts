...
const DEFAULT_PREFIX = `You are DreamSeed Code, a source-first coding agent with memory, skills, MCP, verification, and self-evolution workflows.`
const AGENT_SDK_CLAUDE_CODE_PRESET_PREFIX = `You are DreamSeed Code, a source-first coding agent running within a compatible agent SDK.`
const AGENT_SDK_PREFIX = `You are a DreamSeed agent, built on Anthropic's DreamSeed Agent SDK.`
 ...
 * server verifies this token to confirm the request came from a real DreamSeed
