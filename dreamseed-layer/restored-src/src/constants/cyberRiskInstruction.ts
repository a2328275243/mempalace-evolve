 ...
 *
 * This instruction provides guidance for DreamSeed's behavior when handling
 ...
 *   - How DreamSeed handles penetration testing and CTF requests
 *   - What security tools and techniques DreamSeed will assist with
 ...
 *
 * DreamSeed: Do not edit this file unless explicitly asked to do so by the user.
 */
