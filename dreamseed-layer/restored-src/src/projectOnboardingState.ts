...
export function getSteps(): Step[] {
  ...
  return [
    {
      key: 'workspace',
      text: 'Ask DreamSeed to create a new app or clone a repository',
      isComplete: false,
      isCompletable: true,
    ...
    {
      key: 'claudemd',
      text: 'Run /init to create a DREAMSEED.md file with instructions for DreamSeed',
