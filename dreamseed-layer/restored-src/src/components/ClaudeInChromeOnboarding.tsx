...
export function ClaudeInChromeOnboarding(t0) {
  ...
  let t5;
  if ($[6] !== t4) {
    t5 = <Text>DreamSeed Browser works with the Chrome extension to let you control your browser directly from DreamSeed Code. You can navigate websites, fill forms, capture screenshots, record GIFs, and debug with console logs and network requests.{t4}</Text>;
    $[6] = t4;
    $[7] = t5;
  } else {
    t5 = $[7];
  ...
  if ($[13] === Symbol.for("react.memo_cache_sentinel")) {
    t9 = <Text dimColor={true}>For more info, use{" "}{t8}{" "}or visit <Link url="https://code.dreamseed.com/docs/en/chrome" /></Text>;
    $[13] = t9;
  } else {
    t9 = $[13];
  }
  ...
  let t11;
  if ($[17] !== onDone || $[18] !== t10) {
    t11 = <Dialog title="DreamSeed Browser (Beta)" onCancel={onDone} color="chromeYellow">{t10}</Dialog>;
    $[17] = onDone;
    $[18] = t10;
    $[19] = t11;
  } else {
