  ...
  return <Pane>
      <Box flexDirection="column" gap={1}>
        ...
        <Box flexDirection="column" marginLeft={2}>
          <Text dimColor>
            {referrerReward ? `Share a free week of DreamSeed Code with friends. If they love it and subscribe, you'll get ${formatCreditAmount(referrerReward)} of extra usage to keep building. ` : 'Share a free week of DreamSeed Code with friends. '}
            <Link url={referrerReward ? 'https://support.dreamseed.com/en/articles/13456702-claude-code-guest-passes' : 'https://support.dreamseed.com/en/articles/12875061-claude-code-guest-passes'}>
              Terms apply.
            </Link>
          </Text>
        </Box>
