...
function getNotificationMessage(toolUseConfirm: ToolUseConfirm): string {
  ...
  if (toolUseConfirm.tool === ExitPlanModeV2Tool) {
    return 'DreamSeed Code needs your approval for the plan';
  }
  if (toolUseConfirm.tool === EnterPlanModeTool) {
    return 'DreamSeed Code wants to enter plan mode';
  }
  if (feature('REVIEW_ARTIFACT') && toolUseConfirm.tool === ReviewArtifactTool) {
    return 'DreamSeed needs your approval for a review artifact';
  }
  if (!toolName || toolName.trim() === '') {
    return 'DreamSeed Code needs your attention';
  }
  return `DreamSeed needs your permission to use ${toolName}`;
}
