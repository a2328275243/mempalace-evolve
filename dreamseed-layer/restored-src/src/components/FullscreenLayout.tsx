 ...
 * users think of as "a new message from DreamSeed" — not raw assistant entries
 ...
 * until DreamSeed's text response lands.
 */
...
// conversation turn's prompt above the viewport so you know what DreamSeed was
