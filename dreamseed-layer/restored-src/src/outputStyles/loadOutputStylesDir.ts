...
/**
 * Loads markdown files from .dreamseed/output-styles directories throughout the project
 * and from ~/.dreamseed/output-styles directory and converts them to output styles.
 *
 ...
 *
 * Structure:
 * - Project .dreamseed/output-styles/*.md -> project styles
 * - User ~/.dreamseed/output-styles/*.md -> user styles (overridden by project styles)
 *
